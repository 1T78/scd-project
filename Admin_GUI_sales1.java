 ...
 */
public class Admin_GUI_sales1 implements ActionListener
{
...
//        sales_p_center.add(search_b);
    ...
    public void actionPerformed(ActionEvent ae) 
    {
        if(ae.getSource() == add)
        {
            JDialog add_db =new JDialog((Frame) Admin_GUI.frame,"Add to Drugs List",false);
...
//                money.setText( i+"₹");
        ...
        else if(ae.getSource() == update)
        {
            ...
            {
                JDialog update_db =new JDialog((Frame) Admin_GUI.frame,"Update to Drugs List",false);
